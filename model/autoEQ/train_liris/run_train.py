"""CLI — Phase 2a-0 baseline training for LIRIS-ACCEDE (V5-FINAL §11)."""
...
def override_from_args(cfg: TrainLirisConfig, args: argparse.Namespace) -> TrainLirisConfig:
...
def main() -> int:
    ...
    p.add_argument("--run-name", default="baseline_2a0")
    ...
    model = AutoEQModelLiris(cfg).to(device)
